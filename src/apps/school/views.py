...
class PresenceViewSet(viewsets.ModelViewSet):
	...
	def update(self, request, *args, **kwargs):
		...
		old_presence = instance.present

		serializer = self.get_serializer(instance, data=request.data, partial=partial)
		serializer.is_valid(raise_exception=True)

		if 'present' in serializer.validated_data and instance.absence_report:
			if old_presence is False and serializer.validated_data['present'] is True:
				instance.absence_report.report_until = instance.lesson.start
				instance.absence_report.closed_by = request.user
				instance.absence_report.save()
